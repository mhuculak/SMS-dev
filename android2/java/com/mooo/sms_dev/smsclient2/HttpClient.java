...
public class HttpClient {
    ...
    private static String TAG = "com.mooo.sms_dev.smsclient2.HttpClient";
...
//            Log.i(TAG, "connect enter");
 ...
 //                   Log.i(TAG,key + "=" + URLEncoder.encode(value,"UTF-8") + "&" );
                    out.print(key + "=" + URLEncoder.encode(value, "UTF-8") + "&");
                }
                Log.i(TAG, "connect close output stream");
                out.close();
            }
            ...
            Log.e(TAG, "connect: Caught IO exception: " + ie.toString());
            ie.printStackTrace();
        }
 //       Log.i(TAG, "return " + m_status_code);
        return m_status_code;
    }
